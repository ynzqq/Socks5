...
- 默认账号密码端口：uname=123456 upasswd=654321 port=2222
- 一键开启、关闭ss5服务
...
## 一键安装或更新到最新 ##
 <pre><code>wget -q -N --no-check-certificate https://raw.githubusercontent.com/ynzqq/Socks5/master/install.sh && bash install.sh</code></pre>
